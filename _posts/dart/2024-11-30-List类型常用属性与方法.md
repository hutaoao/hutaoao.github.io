---
title: Dart List 类型常用属性与方法详解
date: 2024-11-30
description: 全面介绍 Dart List 类型的常用属性和方法，包括 length、isEmpty、reversed、add、remove、map、where 等，并对比 JavaScript 的对应用法
tags: [Dart, List, Dart数组, Dart集合操作]
categories: [Dart]
---
...
### followedBy
:**➕**** followedBy(Iterable**** other) → **`**Iterable<E>**`
...
### expand
:**🔄**** expand****(Iterable**** f(E element)) → **`**Iterable<T>**`
