---
title: iNotify-js实现浏览器的title闪烁滚动声音提示-弹出通知
date: 2025-04-28
description: iNotify.js 实现浏览器的title闪烁滚动声音提示，弹出通知
tags: [开发整理]
categories: [开发整理]
---
# iNotify.js 实现浏览器的title闪烁滚动声音提示，弹出通知

JS 实现浏览器的 title 闪烁、滚动、声音提示、chrome、Firefox、Safari等系统弹出通知。它没有依赖，压缩只有只有4.66kb(gzipped: 1.70kb)，[demo 实例预览](https://wangchujiang.com/iNotify/)。



![1574647283066-3919f6b6-fffd-45e1-a59f-1701831c5797.png](./img/571858_zxafppa0uacr9wbb/1574647283066-3919f6b6-fffd-45e1-a59f-1701831c5797-158306.png)
