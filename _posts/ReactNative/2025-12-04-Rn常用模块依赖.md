...
### <font style="color:rgb(0, 0, 0);">动画</font>

`react-native-animatable`

**<font style="color:rgb(0, 0, 0);">�</font>**

### <font style="color:rgb(0, 0, 0);">弹窗解决方案</font>

`react-native-root-siblings`

### <font style="color:rgb(0, 0, 0);">音频</font>

<code><font style="color:rgb(0, 0, 0);">react-native-track-player</font></code>

**<font style="color:rgb(0, 0, 0);"></font>**

### <font style="color:rgb(77, 77, 77);">保存图片/获取手机图片 > 图片上传(常用于上传头像功能)</font>

<code><font style="color:rgb(77, 77, 77);">@react-native-camera-roll/camera-roll</font></code>
...
### <font style="color:rgb(0, 0, 0);">获取设备信息</font>

`react-native-device-info`

<font style="color:rgb(0, 0, 0);">�</font>

### <font style="color:rgb(0, 0, 0);">SVG</font>
...
<font style="color:rgb(0, 0, 0);">然后在package.json 加入一个命令：</font>`"build:svg": "node scripts/svg/index.js"`

<font style="color:rgb(0, 0, 0);">�执行命令就会在 assets/svg目录下生成 index.js 文件</font>

<font style="color:rgb(0, 0, 0);">然后就可以封装</font><code><font style="color:rgb(0, 0, 0);">MyIcon</font></code><font style="color:rgb(0, 0, 0);">组件：</font>
...
> 更新: 2026-03-06 11:39:55  
> 原文: <https://www.yuque.com/hutaoao/blog/ewru4yeyxp44wedn>