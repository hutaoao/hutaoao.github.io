...
这个API主要使用的就是三个方法，用于检查是否拥有权限的<code>**check**</code>方法，请求权限的<code>**request**</code>方法，请求多个权限的<code>**requestMultiple**</code>方法，
...
据说 <code>6.0</code> 以下版本，权限写在**AndroidManifest.xml**文件里就好，这个时候权限都可以直接请求到，这个时候的check始终返回**true**，并且request请求始终返回**PermissionsAndroid.RESULTS.GRANTED**，\ 写法和下面六点零以上版本一样
