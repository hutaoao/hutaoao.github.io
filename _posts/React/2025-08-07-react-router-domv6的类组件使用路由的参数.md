...
**<font style="color:rgb(77, 77, 77);">react-router从v5升级到v6之后做了非常大的改动</font>**

**<font style="color:rgb(77, 77, 77);"></font>**

**<font style="color:rgb(77, 77, 77);">在类组件中，发现props是一个空对象！！！</font>**<font style="color:rgb(77, 77, 77);"> </font>
...
<font style="color:rgb(77, 77, 77);">自己编写高阶组件</font><font style="color:rgb(199, 37, 78);background-color:rgb(249, 242, 244);">withRouter</font><font style="color:rgb(77, 77, 77);">从而实现这一需求，可以看看这篇文章中的回答：</font>[https://cloud.tencent.com/developer/ask/sof/296970](https://cloud.tencent.com/developer/ask/sof/296970)
