...
最近， [Nicholas C. Zakas](https://www.nczonline.net/) 文章[《Iframes, onload, and document.domain》](https://www.nczonline.net/blog/2009/09/15/iframes-onload-and-documentdomain/)的评论中 Christopher 提供了一个新的判断方法（很完美）：
