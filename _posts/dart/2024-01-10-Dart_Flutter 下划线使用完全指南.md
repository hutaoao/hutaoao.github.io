---
title: Dart/Flutter 下划线使用完全指南
date: 2024-01-10
description: 全面介绍 Dart 语言中下划线的各种用法、含义和最佳实践，包括类定义、类成员、顶层定义中的下划线使用，以及在 Flutter 中的特殊应用场景
tags: [Dart, Flutter, Dart下划线, 访问控制, 封装性]
categories: [Dart]
---

## <font style="color:rgb(15, 17, 21);">一、概述</font>
<font style="color:rgb(15, 17, 21);">在 Dart 语言中，下划线 (</font>`<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">_</font>`<font style="color:rgb(15, 17, 21);">) 是实现</font>**<font style="color:rgb(15, 17, 21);">访问控制</font>**<font style="color:rgb(15, 17, 21);">和</font>**<font style="color:rgb(15, 17, 21);">封装性</font>**<font style="color:rgb(15, 17, 21);">的核心机制。本指南将全面介绍 Dart 和 Flutter 中下划线的各种用法、含义和最佳实践。</font>
...
4. **<font style="color:rgb(15, 17, 21);">Widget 模式</font>**<font style="color:rgb(15, 17, 21);">：State 类通常私有化，使用</font><font style="color:rgb(15, 17, 21);"> </font>`<font style="color:rgb(15, 17, 21);background-color:rgb(235, 238, 242);">_WidgetNameState</font>`
