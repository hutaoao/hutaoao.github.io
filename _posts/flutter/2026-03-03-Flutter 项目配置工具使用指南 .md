...
description: "详细介绍 Flutter 项目中常用的配置工具，包括 flutter_native_splash 启动页配置、flutter_launcher_icons 应用图标配置和 change_app_package_name 包名修改工具的使用方法和常见问题解决。"
...
**💡说明**：`drawable` 目录下看不到 `splash.png` 是**完全正常的**，因为图片按分辨率分散在各个目录中，Android 系统会自动选择合适的版本。
