---
title: Dart 数字类型常用属性与方法详解
date: 2024-09-02
description: 全面介绍 Dart 数字类型（num）的常用属性和方法，包括 isNegative、isFinite、isNaN、sign、abs、round、floor 等属性和方法
tags: [Dart, num, Dart数字类型, Dart数学运算]
categories: [Dart]
---
