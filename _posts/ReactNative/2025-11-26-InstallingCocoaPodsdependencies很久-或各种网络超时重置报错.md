...
其实就是国内网络原因（<font style="color:rgb(28, 30, 33);">CocoaPods 的源必须使用代理访问</font>）

此时就算你本机开启了代理，浏览器也能访问谷歌了，但是你再次执行 `pod install` 也可能还是失败的，原因就是您的<font style="color:rgb(77, 77, 77);">终端默认不走代理，需要手动配置终端代理。</font>

### 解决方法：

**<font style="color:#E8323C;">推荐方法一</font>**
