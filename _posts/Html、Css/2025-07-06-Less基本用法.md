...
Less 内置了多种函数用于转换颜色、处理字符串、算术运算等。这些函数在[Less 函数](https://less.bootcss.com/functions/)手册中有详细介绍。
...
> 更新: 2024-07-11 13:20:16  
> 原文: <https://www.yuque.com/hutaoao/blog/bw46xp>