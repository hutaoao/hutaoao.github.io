...
<font style="color:rgb(64, 64, 64);">ConstrainedBox 是 Flutter 中一个非常实用的布局组件，它允许你对子组件施加额外的约束条件（constraints）。</font>

> <font style="color:rgb(64, 64, 64);">类似鸿蒙的通用属性</font> <code>**constraintSize**</code>

## <font style="color:rgb(64, 64, 64);">基本概念</font>

<font style="color:rgb(64, 64, 64);">ConstrainedBox 会在其子组件上施加额外的约束（BoxConstraints），这些约束会与父组件传递下来的约束合并。</font>
...
## <font style="color:rgb(64, 64, 64);">常见用法</font>

### <font style="color:rgb(64, 64, 64);">1. 设置最小/最大尺寸（蓝色盒子）</font>
...
### <font style="color:rgb(64, 64, 64);">2. 强制宽高比（红色16:9盒子）</font>
...
### <font style="color:rgb(64, 64, 64);">3. 限制文本按钮的最小尺寸</font>
...
### <font style="color:rgb(64, 64, 64);">4. 固定大小的绿色盒子</font>
...
### <font style="color:rgb(64, 64, 64);">5. 与Expanded结合使用（行布局）</font>
...
### <font style="color:rgb(64, 64, 64);">实用技巧1：全宽按钮</font>
...
### <font style="color:rgb(64, 64, 64);">实用技巧2：响应式尺寸限制</font>
